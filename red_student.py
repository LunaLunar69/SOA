...
# CARGA DEL TEACHER Y EXTRACCIÓN DE CAPAS
...
# Extraer la primera capa Conv1D y la salida final para la destilación
...
def build_student_model(window_size, num_features):
    ...
    # El modelo devuelve: Conv1D y la predicción final
